...
export const InstrumentAnalysisWidget: React.FC<InstrumentAnalysisWidgetProps> = ({
  ...
  return (
    <div
      ...
      className={`relative w-full rounded-2xl sm:rounded-3xl border border-indigo-200/80 ${containerBgClassName} ${noShadow ? '' : 'shadow-2xs transition-all hover:shadow-xs'} interactive-card ${className}`}
    >
