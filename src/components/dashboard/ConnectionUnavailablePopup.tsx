...
interface ConnectionUnavailablePopupProps {
  isOpen: boolean;
  onClose: () => void;
  onConnectNewBrokers: () => void;
  brokerName?: string;
  supportPhone?: string;
  supportEmail?: string;
}

export const ConnectionUnavailablePopup: React.FC<ConnectionUnavailablePopupProps> = ({
  isOpen,
  onClose,
  onConnectNewBrokers,
  brokerName = 'HFM',
  ...
  return (
    <div
      id="connection-unavailable-popup-backdrop"
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-150"
      onClick={onClose}
    >
      <div
        id="connection-unavailable-popup"
      ...
      >
        ...
        <button
          type="button"
          id="connection-unavailable-close-btn"
          onClick={onClose}
        ...
        {/* Action Button: Connect New Brokers (single full-width button) */}
        <div className="w-full">
          <button
            type="button"
            id="connection-unavailable-connect-btn"
            onClick={onConnectNewBrokers}
